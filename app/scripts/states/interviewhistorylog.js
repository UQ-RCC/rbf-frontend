...
angular.module('qldarchApp').config(
    function($stateProvider) {
      $stateProvider.state('interviewhistorylog', {
            ...
            return $http({
              ...
              angular.forEach(response.data, function(d) {
                ...
                if (angular.isDefined(d.document.location)) {
                  d.document['Location of Interview'] = d.document.location;
        ...
        controller : [ '$scope', 'interviewhstlog', 'ObjectDiff', 'interview', 'ArchObj', '$state',
            function($scope, interviewhstlog, ObjectDiff, interview, ArchObj, $state) {
